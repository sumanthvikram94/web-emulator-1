...
Server.prototype = {
  ...
  start: Promise.coroutine(function*() {
    ...
    this.webServer.setConfig(wsConfig, this.userConfig.adminConfig);
    ...
    const webAppOptions = {
      ...
      oldRootRedirectURL: this.appConfig.oldRootRedirectURL,
      rootRedirectURL: this.appConfig.rootRedirectURL,
      bzadmRedirectURL: this.appConfig.bzadmRedirectURL,
      ssoRedirectURL: this.appConfig.ssoRedirectURL,
      ssoConfigPath: this.appConfig.ssoConfigPath,
