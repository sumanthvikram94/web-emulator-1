...
import { PeerDiscovery } from '../main/metadata.js';
...
class PrivateNetNode {
    constructor(worker, net) {
        this._listening = false;
        this._doStart = true; // Should start the node or not.
        this._worker = worker;
        this._net = net;
    ...
    async updateNodeMetadata() {
        ...
        this._meta.peerId = {
            id: this._meta.id,
            pubKey: Buffer.from(this._node.peerId.publicKey).toString('base64'),
    ...
    async start() {
        ...
        const libp2pConfig = {
            peerId: this._nodeMeta.peerIdInst,
            addresses: {
    ...
    configPeerDiscovery(libp2pConfig) {
