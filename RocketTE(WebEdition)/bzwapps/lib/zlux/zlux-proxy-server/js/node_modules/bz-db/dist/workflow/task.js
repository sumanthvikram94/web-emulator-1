...
(function (TaskStatus) {
    ...
    TaskStatus[TaskStatus["DESTROYED"] = 5] = "DESTROYED";
})(TaskStatus || (TaskStatus = {}));
class Task extends EventEmitter {
    constructor(id, options, fun) {
        super();
    ...
    destroy() {
        if (this.parentId && this.parentId !== '' && this._workflow._tasks.has(this.parentId))
            return; // destroying child task might cause issue. Leave the child destroy to when parent destroy triggers
