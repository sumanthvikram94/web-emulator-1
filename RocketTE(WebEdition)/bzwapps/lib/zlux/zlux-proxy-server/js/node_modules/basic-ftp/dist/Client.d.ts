...
export declare type TransferStrategy = (ftp: FTPContext) => Promise<FTPResponse>;
/** Parses raw directoy listing data. */
export declare type RawListParser = (rawList: string, serverType: number, JES: number, hasMLSD: boolean, ftp: FTPContext) => any[];
...
export declare class Client {
    ...
    protected ftpserverType: number;
    protected JES: number;
    protected hasMLSD: boolean;
    /**
     * Instantiate an FTP client.
     *
     * @param timeout  Timeout in milliseconds, use 0 for no timeout. Optional, default is 30 seconds.
     */
    constructor(passive?: boolean, timeout?: number);
    /**
     ...
     */
    connect(host?: string, port?: number, keepAliveTimerOptions?: string, keepAliveTimerValue?: string): Promise<FTPResponse>;
    /**
     * As `connect` but using implicit TLS. Implicit TLS is not an FTP standard and has been replaced by
     * explicit TLS. There are still FTP servers that support only implicit TLS, though.
     */
    connectImplicitTLS(host?: string, port?: number, tlsOptions?: TLSConnectionOptions, keepAliveTimerOptions?: string, keepAliveTimerValue?: string): Promise<FTPResponse>;
    /**
     ...
     */
    list(command?: string): Promise<any>;
    /**
     * @protected
     */
    protected _requestListWithCommand(command: string): Promise<any>;
    /**
     ...
     */
    archiveDir(destination: Writable, modeOptions?: any, remoteDirPath?: string): Promise<void>;
    /**
     * @protected
     */
    protected _archiveFromWorkingDir(archive: archiver.Archiver, modeOptions?: any, parent?: string): Promise<void>;
    private _getAutoType;
    /**
