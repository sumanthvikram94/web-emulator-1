...
export declare class FTPContext {
    ...
    _closingError: NodeJS.ErrnoException | undefined;
    ...
    protected keepAliveTimer: NodeJS.Timer | undefined;
    protected keepAliveTimerOptions: string;
    protected keepAliveTimerValue: string;
    portActive: boolean;
    ...
    setKeepAlive(option: string, timer: string): void;
    /**
     * Close the context.
     */
    close(): void;
    ...
    get keepalive(): NodeJS.Timer | undefined;
    /**
     ...
     * @protected
     */
    _passToHandler(response: Error | FTPResponse): void;
    /**
